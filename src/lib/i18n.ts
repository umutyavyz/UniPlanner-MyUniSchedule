export const translations = {
  tr: {
    ...
    shareURL: 'Link Olarak Paylaş',
    urlCopied: 'Link kopyalandı!',
    textCopied: 'Program kopyalandı!',
    restoreSuccess: 'Yedek başarıyla yüklendi!',
    restoreError: 'Yedek dosyası hatalı.',
    ...
    minTimeSlotWarning: 'En az bir zaman dilimi olmalıdır.',
    days: {
      monday: 'Pazartesi',
      tuesday: 'Salı',
      wednesday: 'Çarşamba',
    ...
    footer: {
      ...
      tools: 'Araçlar',
      scheduleMaker: 'Ders Programı',
      gpaCalculator: 'Ortalama Hesaplama',
      finalCalculator: 'Vize Final Hesaplama',
      pomodoro: 'Pomodoro Sayacı',
  ...
  en: {
    ...
    shareURL: 'Share as Link',
    urlCopied: 'Link copied!',
    textCopied: 'Schedule copied!',
    ...
    minTimeSlotWarning: 'At least one time slot is required.',
    days: {
      monday: 'Monday',
      tuesday: 'Tuesday',
      wednesday: 'Wednesday',
    ...
    footer: {
      ...
      gpaCalculator: 'GPA Calculator',
      finalCalculator: 'Final Calculator',
