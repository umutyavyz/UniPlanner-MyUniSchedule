...
export default function GPACalculatorClient() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950 font-sans text-gray-900 dark:text-gray-100 transition-colors">
              ...
              <>
                ...
                <div className="absolute top-full right-0 mt-2 w-32 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-100 dark:border-gray-800 p-1 z-40 animate-fade-in">
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${settings.language === 'tr'
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${settings.language === 'en'
                      ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400'
                      : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
                      }`}
                  >
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200/60 dark:border-gray-800 p-6 mb-6">
          ...
          <div className="space-y-4">
            {courses.map((course, index) => (
              <div
                key={course.id}
                className={`flex flex-col sm:flex-row gap-4 items-start sm:items-center bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-100 dark:border-gray-800 transition-all duration-300 ease-in-out hover:border-gray-200 dark:hover:border-gray-700 ${exitingItems.includes(course.id) ? 'opacity-0 translate-x-10 pointer-events-none' : 'opacity-100 translate-x-0'
                  }`}
              >
      ...
      {/* Marketing Sections - Moved up */}
      <ToolMarketingSections lang={settings.language as 'tr' | 'en'} tool="gpa" hideScrollIndicator={true} hideFaq={true} />
